  ...
  in
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {
        ...
        virtualenv = editablePythonSet.mkVirtualEnv "metazooa-dev-env" workspace.deps.all;
      ...
      in {
        ...
        packages.default = mkApplication {
          venv = pythonSet.mkVirtualEnv "metazooa-env" workspace.deps.default;
          package = pythonSet.metazooa;
        };

        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/metazooa";
        };
